public class ArrayDemo {
	public static void main(String[] args) {
		...
		Object obj1 = matrixA;
		Object obj2 = matrixA[1];
		int[] oneRow = (int[]) obj2;
		
		System.out.println("-----------------");
		// irregular dimensional array
		int[][] irrArray = new int[3][];
		irrArray[0] = new int[2];
		irrArray[1] = new int[4];
		irrArray[2] = new int[1];
		...
		Room room1 = new Room(100, 80, 50);
		
		Room[] myRooms = new Room[3];
		myRooms[0] = new Room(300, 200, 50);
		myRooms[1] = new Room(350, 250, 50);
		myRooms[2] = new Room(210, 100, 50);
		
		for(Room eachRoom: myRooms) {
